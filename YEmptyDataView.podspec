#
# Be sure to run `pod lib lint YEmptyDataView.podspec' to ensure this is a
...
TODO: uitableview 或uicollectionview 为空的界面显示.
  ...
  s.source           = { :git => 'https://github.com/YaoChengZhen/YEmptyDataView.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'YEmptyDataView' => ['YEmptyDataView/Assets/*.png']
  # }
